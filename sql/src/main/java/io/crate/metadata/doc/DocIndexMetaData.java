...
public class DocIndexMetaData {
    ...
    private ImmutableMap<String, Expression> checkConstraints;
    ...
    private ImmutableMap<String, Expression> getCheckConstraints() {
        Map<String, Object> metaMap = Maps.get(mappingMap, "_meta");
        if (metaMap != null) {
            ...
            if (checkConstraintsMap != null) {
                for (Map.Entry<String, String> entry : checkConstraintsMap.entrySet()) {
                    builder.put(entry.getKey(), SqlParser.createExpression(entry.getValue()));
                }
                return builder.build();
            }
        }
    ...
    ImmutableMap<String, Expression> checkConstraints() {
