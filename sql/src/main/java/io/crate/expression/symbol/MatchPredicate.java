...
public class MatchPredicate extends Symbol {
    ...
    private final Map<ScopedSymbol, Symbol> identBoostMap;
    private final Symbol queryTerm;
    private final String matchType;
    private final Symbol options;

    public MatchPredicate(Map<ScopedSymbol, Symbol> identBoostMap,
                          Symbol queryTerm,
                          String matchType,
                          Symbol options) {
    ...
    public Map<ScopedSymbol, Symbol> identBoostMap() {
